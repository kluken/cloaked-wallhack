						...
						<p>
							<fieldset>
								...
								<table id = "elecTable">
									<tr>
										<th>
											<input type = "checkbox" id = "packSOCA" name = "selectedData[]" value = "Pack State of Charge (Ah)"> <label for = "packSOCA"> Pack State of Charge (Ah)</label>
										</th>
										<th>
							...
							foreach ($_SESSION['electricalSelectedData'] as $key => $entry)
							{
								if ( $count % 6 != 0)
								{
									...
									if ($result != false && mysqli_num_rows($result) > 0)
									{
										...
										else if ($entry == "MPPT 1 Iin" || $entry == "MPPT 2 Iin")
										{
											$inputCurrent = $row[$tableName] * 0.87 * 0.01;
											echo "<td>";
											echo $inputCurrent;
											echo "</td>";
										}
										else if ($entry == "MPPT 1 Vin" || $entry == "MPPT 2 Vin")
										{
											$inputVoltage = $row[$tableName] * 1.5 * 0.1;
											echo "<td>";
											echo $inputVoltage;
											echo "</td>";
										}
										else if ($entry == "MPPT 1 Vout" || $entry == "MPPT 2 Vout")
										{
											$inputVoltage = $row[$tableName] * 2.1 * 0.1;
											echo "<td>";
											echo $inputVoltage;
											echo "</td>";
										}
