...
function sqlLookup($dataName)
{
	...
	{
		return "SELECT `SOCA` FROM `Pack_State_of_Charge` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Pack State of Charge (%)") == 0)
	{
		return "SELECT `SOCP` FROM `Pack_State_of_Charge` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Balance State of Charge (Ah)") == 0)
	{
		return "SELECT `Balance_SOCA` FROM `Pack_Balance_State_of_Charge` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Balance State of Charge (%)") == 0)
	{
		return "SELECT `Balance_SOCP` FROM `Pack_Balance_State_of_Charge` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Charging Cell Voltage Error (mV)") == 0)
	{
		return "SELECT `Charging_Cell_Voltage_Error` FROM `Charger_Control_Information` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Cell Temp Margin") == 0)
	{
		return "SELECT `Cell_Temperature_Margin` FROM `Charger_Control_Information` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Discharging Cell Voltage Error (mV)") == 0)
	{
		return "SELECT `Discharging_Cell_Voltage_Error` FROM `Charger_Control_Information` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Total Pack Capacity (Ah)") == 0)
	{
		return "SELECT `Total_Pack_Capacity` FROM `Charger_Control_Information` ORDER BY id DESC LIMIT 1";
	}
	...
	{
		return "SELECT `Precharge_State` FROM `Precharge_Status` ORDER BY id DESC LIMIT 1";
	}
	...
	{
		return "SELECT `Precharge_Timer_Elapsed` FROM `Precharge_Status` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Precharge Timer") == 0)
	{
		return "SELECT `Precharge_Timer_Counter` FROM `Precharge_Status` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Minimum Cell Voltage") == 0)
	{
		return "SELECT `Minimum_Cell_Voltage` FROM `Minimum_/_Maximum_Cell_Voltage` ORDER BY id DESC LIMIT 1";
	}
	...
	{
		return "SELECT `Maximum_Cell_Voltage` FROM `Minimum_/_Maximum_Cell_Voltage` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "CMU With Maximum Cell Voltage") == 0)
	{
		return "SELECT `CMU_with_Maximum_Voltage` FROM `Minimum_/_Maximum_Cell_Voltage` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Cell With Maximum Voltage") == 0)
	{
		return "SELECT `Cell_with_Maximum_Voltage` FROM `Minimum_/_Maximum_Cell_Voltage` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Minimum CMU Temp") == 0)
	{
		return "SELECT `Minimum_Cell_Temperature` FROM `Minimum_/_Maximum_Cell_Temperature` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "CMU With Minimum Temperature") == 0)
	{
		return "SELECT `CMU_with_Minimum_Cell_Temperature` FROM `Minimum_/_Maximum_Cell_Temperature` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Maximum CMU Temp") == 0)
	{
		return "SELECT `Maximum_Cell_Temperature` FROM `Minimum_/_Maximum_Cell_Temperature` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "CMU With Maximum Temperature") == 0)
	{
		return "SELECT `CMU_with_Maximum_Cell_Temperature` FROM `Minimum_/_Maximum_Cell_Temperature` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Battery Voltage (mV)") == 0)
	{
		return "SELECT `Battery_Voltage` FROM `Battery_Pack_Voltage_/_Current` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Battery Current (mA)") == 0)
	{
		return "SELECT `Battery_Current` FROM `Battery_Pack_Voltage_/_Current` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Battery Voltage Threshold (Rising - V)") == 0)
	{
		return "SELECT `Balance_Voltage_Threshold_-_Rising` FROM `Battery_Pack_Status` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Battery Voltage Threshold (Falling - V)") == 0)
	{
		return "SELECT `Balance_Voltage_Threshold_-_Falling` FROM `Battery_Pack_Status` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Cells Under Voltage") == 0)
	{
		return "SELECT `Cell_Under_Voltage` FROM `Extended_Battery_Pack_Status` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Cells Over Voltage") == 0)
	{
		return "SELECT `Cell_Over_Voltage` FROM `Extended_Battery_Pack_Status` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Cells Over Temperature") == 0)
	{
		return "SELECT `Cell_Over_Temperature` FROM `Extended_Battery_Pack_Status` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Measurements Untrusted") == 0)
	{
		return "SELECT `Measurement_Untrusted` FROM `Extended_Battery_Pack_Status` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "CMU Comms Timeout") == 0)
	{
		return "SELECT `CMU_Communications_Timeout` FROM `Extended_Battery_Pack_Status` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "BMU Is in Setup Mode") == 0)
	{
		return "SELECT `BMU_is_in_Setup_Mode` FROM `Extended_Battery_Pack_Status` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "CMU CAN Bus Power Status") == 0)
	{
		return "SELECT `CMU_CAN_Bus_Power_Status` FROM `Extended_Battery_Pack_Status` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Pack Isolation Test Fail") == 0)
	{
		return "SELECT `Pack_Isolation_Test_Failure` FROM `Extended_Battery_Pack_Status` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "SOC Measurement Not Valid") == 0)
	{
		return "SELECT `SOC_Measurement_is_not_Valid` FROM `Extended_Battery_Pack_Status` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "12V CAN Supply Too Low") == 0)
	{
		return "SELECT `CAN_12V_Too_Low` FROM `Extended_Battery_Pack_Status` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Contactor Stuck / Not Engaged") == 0)
	{
		return "SELECT `Contactor_is_Stuck_/_Not_Engaged` FROM `Extended_Battery_Pack_Status` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "CMU Detected Extra Cell") == 0)
	{
		return "SELECT `CMU_has_detected_an_extra_Cell` FROM `Extended_Battery_Pack_Status` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "CMU Count") == 0)
	{
		return "SELECT `BMS_CMU_Count` FROM `Battery_Pack_Status` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "BMU Firmware Build") == 0)
	{
		return "SELECT `BMU_Hardware_Version` FROM `Extended_Battery_Pack_Status` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Fan 0 Speed") == 0)
	{
		return "SELECT `Fan_Speed_0` FROM `Battery_Pack_Fan_Status` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Fan 1 Speed") == 0)
	{
		return "SELECT `Fan_Speed_1` FROM `Battery_Pack_Fan_Status` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Fan and Contactor 12V Consumption (mA)") == 0)
	{
		return "SELECT `12V_Current_Consumption_of_Fans_and_Contactors` FROM `Battery_Pack_Fan_Status` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "12V CMU's") == 0)
	{
		return "SELECT `12V_Current_Consumption_of_CMUs` FROM `Battery_Pack_Fan_Status` ORDER BY id DESC LIMIT 1";
	}
	...
	{
		return "SELECT `BMU_Model_ID` FROM `Extended_Battery_Pack_Status` ORDER BY id DESC LIMIT 1";
	}
	...
	{
		return "SELECT `Over_Temperature` FROM `MPPT1` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "No Connection to MPPT1") == 0)
	{
		return "SELECT `No_Connection` FROM `MPPT1` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Under Voltage on MPPT1 Input") == 0)
	{
		return "SELECT `Under_Voltage` FROM `MPPT1` ORDER BY id DESC LIMIT 1";
	}
	...
	{
		return "SELECT `Over_Temperature` FROM `MPPT2` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "No Connection to MPPT2") == 0)
	{
		return "SELECT `No_Connection` FROM `MPPT2` ORDER BY id DESC LIMIT 1";
	}
	else if (strcmp($dataName, "Under Voltage on MPPT2 Input") == 0)
	{
		return "SELECT `Under_Voltage` FROM `MPPT2` ORDER BY id DESC LIMIT 1";
	}
	else
	{
		return "";
